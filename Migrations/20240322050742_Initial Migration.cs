        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AntiPishingCode = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVirtualCard = table.Column<bool>(type: "boolean", nullable: false),
                    VinculatedCardNumber = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Cards_Cards_VinculatedCardNumber",
                        column: x => x.VinculatedCardNumber,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountId = table.Column<int>(type: "integer", nullable: false),
                    AccountToOrFromId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_AccountToOrFromId",
                        column: x => x.AccountToOrFromId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cards_VinculatedCardNumber",
                table: "Cards",
                column: "VinculatedCardNumber");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AccountToOrFromId",
                table: "Transactions",
                column: "AccountToOrFromId");
        }
